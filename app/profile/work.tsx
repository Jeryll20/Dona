...
export default function WorkScreen() {
  ...
  const [employed,  setEmployed]  = useState(stored.employed  ?? false);
  ...
  function handleSave() {
    setWork({
      employed,
      role:      employed ? role      : undefined,
      days:      employed ? days      : undefined,
      startTime: employed ? startTime : undefined,
      endTime:   employed ? endTime   : undefined,
    });
    router.back();
  }
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.toggleRow}>
          <View style={{ flex: 1 }}>
            <Text style={styles.toggleLabel}>J'ai un emploi ou des études</Text>
            <Text style={styles.toggleSub}>Active pour afficher le créneau dans le planning</Text>
          </View>
          <Switch
            value={employed}
            ...
            accessibilityLabel="Activer l'emploi"
          />
        </View>
